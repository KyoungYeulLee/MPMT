...
def load_params():
	...
	fixed = {
		...
		'simultaneous': False, # Use train_and_test() function. True for singletask.py, MT_binary.py, MPMT.py
		...
		'batch_bal': True, # balance between classes in training batches (=task weighting)
